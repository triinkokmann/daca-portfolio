...
# Logimine seadistatakse üks kord pipeline'i tasemel.
# %(asctime)s lisab automaatselt kellaaja — kasulik, kui pipeline
# käib öösiti ja tahad hiljem logifailist näha, mis kell midagi juhtus.
