...
- **Logimine** — Rakendatud on failipõhine logimine, mis tähendab, et kõik etapid kirjutavad logid logs/pipeline_YYYYMMDD.log faili koos kellaaegadega, et hiljem saaks täpselt näha, mis hetkel mingi probleem tekkis.
...
## Turvalisus
API URL ja võti on .env failis — need ei lähe koodi ega GitHubi. Repos on ainult .env.example näidis tühjade väärtustega.
